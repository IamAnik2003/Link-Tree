        ...
        <div className={styles.container1}>
          ...
          <div className={styles.flex3}>
            <div className={styles.child5}>
              ...
              <p>
                Connect your content in all its forms and help followers find
                more of what they’re looking for. Your TikToks, Tweets, YouTube
                videos, music, articles, recipes, podcasts and more… It all
                comes together in one powerful place
              </p>
            </div>
            <div className={styles.child6}>
              ...
              <img src={img3} alt="" />
              <img src={img4} alt="" />
              <h5>Share your content in limitless ways on your Spark</h5>
            </div>
          </div>
          ...
          <div>
            <h1 style={isMobile ? { fontSize: "1.6em" } : {}}>
            ...
            <div className={styles.child11}>
              ...
              <div className={styles.inchild2}>
                <p
                  style={
                    isMobile
                      ? { fontSize: "0.8em", width: "100%", marginTop: "-8%" }
                      : {}
                  }
                >
                  About Spark
